...
from apps.accounts.models import Employer, JobSeeker  # Added JobSeeker here
import openpyxl
...
def home(request):
    ...
    # NEW: Fetch Job Seekers for the purple boxes on your homepage
    job_seekers = JobSeeker.objects.all()[:3] 
    
    context = {
        'featured_jobs': featured_jobs,
        'categories': categories,
        'job_seekers': job_seekers,  # Passing this to home.html
    }
